...
<body>
	<section class="sub-header">
		...
		<h1>Start writing your journal</h1>
	...
	<div class="row">
		<div class="contact-col">
			...
			<form action="AddNotesServlet" method="post">
				...
				<input type="text" name="title" placeholder="Enter Your Subject"
					required>
				<textarea rows="40" name="content"
					placeholder="Pendown your thoughts here" required></textarea>

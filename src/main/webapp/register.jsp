		...
		<nav>
			...
			<div class="nav-links" id="navLinks">
				...
				<ul>
					...
					<!-- <li><a href="register.jsp">ADD NOTES</a></li>
					<li><a href="register.jsp">SHOW NOTES</a></li> -->
				</ul>
			</div>
	...
	<section class="contact-us">
		<div class="row">
			<div class="contact-col">
					...
					<%
					String regFailMsg = (String)session.getAttribute("reg-failed");	
					if(regFailMsg!= null){%>
